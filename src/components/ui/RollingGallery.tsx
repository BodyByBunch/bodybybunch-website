...
// RollingGallery component from reactbits.dev
...
const RollingGallery: React.FC<RollingGalleryProps> = ({
  ...
  const cylinderWidth: number = isScreenSizeSm ? 1400 : 2400; // Increased to spread faces more
  const faceCount: number = galleryImages.length;
  const faceWidth: number = (cylinderWidth / faceCount) * 1.2; // Increased to make images properly sized
  const radius: number = (cylinderWidth / (2 * Math.PI)) * 0.6; // Reduced radius to bring faces closer
