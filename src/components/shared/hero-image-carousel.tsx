  ...
  return (
    <div className={className}>
      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute inset-0 bg-media-overlay/25" />
      </div>
        ...
        {images.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-200 ${
              index === currentIndex 
                ? 'bg-section-strong-foreground' 
                : 'bg-section-strong-foreground/50 hover:bg-section-strong-foreground/75'
            }`}
      ...
      {showBadges && (
        <>
          <div className="hidden lg:block absolute top-4 right-4 bg-surface-raised p-6 rounded-2xl shadow-xl border border-border z-10">
          ...
          <div className="hidden lg:block absolute bottom-4 left-4 bg-surface-raised p-6 rounded-2xl shadow-xl border border-border z-10">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-background rounded-xl flex items-center justify-center border border-border">
          ...
          <div className="hidden lg:block absolute top-1/2 left-4 transform -translate-y-1/2 bg-surface-raised p-4 rounded-2xl shadow-xl border border-border z-10">
